...
require_once( "$IP/wpi/extensions/PopularPathways/PopularPathways.php" );
require_once( "$IP/wpi/extensions/MostEditedPathways/MostEditedPathways.php" );
require_once( "$IP/wpi/extensions/NewPathways/NewPathways.php" );
require_once( "$IP/wpi/extensions/CreatePathway/CreatePathway.php" );
...
require_once( "$IP/wpi/extensions/DiffApplet/DiffApplet.php" );
