	...
	static function getJsDependencies() {
		...
		if(preg_match('/(?i)msie [6-8]/',$_SERVER['HTTP_USER_AGENT'])) {
			...
			$scripts = array(
				...
				"$wgScriptPath/wpi/lib/pvjs/2.4.38/polyfills.bundle.min.js",
				//"$wgScriptPath/wpi/lib/pvjs/dev/pvjs.core.js",
				//"$wgScriptPath/wpi/lib/pvjs/dev/pvjs.custom-element.js",
				"$wgScriptPath/wpi/lib/pvjs/2.4.38/pvjs.core.min.js",
				"$wgScriptPath/wpi/lib/pvjs/2.4.38/pvjs.custom-element.min.js",
			);
		}
